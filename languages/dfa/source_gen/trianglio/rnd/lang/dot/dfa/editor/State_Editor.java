...
public class State_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_sjqidp_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_sjqidp_a0(editorContext, node));
    return editorCell;
  }

  private EditorCell createProperty_sjqidp_a0(EditorContext editorContext, SNode node) {
